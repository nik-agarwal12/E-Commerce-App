...
export const ProductCardHorizontal = (props) => {
  const { id, name, image, oldPrice, newPrice, discount, quantity } =
    props.product;
  ...
  return (
    <div
      className={`card-horizontal d-flex shadow my-2 bg-${
    ...
    >
      ...
      <div className="card-details d-flex direction-column">
        ...
        <div className="card-description">
          <p
            className={`card-price text-${
              props.mode === "light" ? "dark" : "light"
            }`}
          >
            Rs. {newPrice}
            <span
              className={`price-strike-through padding-all-8 text-${
                props.mode === "light" ? "dark" : "light"
              }`}
            >
              Rs. {oldPrice}
        ...
        <div className="cta-btn d-flex gap">
          <div className="cta-btn">
            <button
              ...
              className={`button hori-btn btn-outline-${
                props.mode === "light" ? "" : "secondary"
              } btn-primary btn-icon d-flex align-center justify-center gap cursor btn-margin`}
            >
              {" "}
              Remove From Cart
            </button>
          ...
          <div className="cta-btn">
            <button
              ...
              } btn-icon d-flex align-center justify-center gap cursor btn-margin text-${
                props.mode === "light" ? "dark" : "light"
              }`}
            >
              Move to ❤️
