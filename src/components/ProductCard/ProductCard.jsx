...
export const ProductCard = (props) => {
  const { id, name, image, oldPrice, newPrice, rating, discount } =
    props.product;
  ...
  return (
    <div
      className={`card card-vertical d-flex direction-column relative shadow bg-${props.mode}`}
    >
      ...
      <div className="card-details">
        ...
        <div className="card-description">
          <p className="card-price d-flex align-end">
            ...
            <span
              className={`price-strike-through text-${
                props.mode === "light" ? "dark" : "light"
              }`}
            >
              Rs. {oldPrice}
          ...
          <p
            className={`d-flex align-center text-${
              props.mode === "light" ? "dark" : "light"
            }`}
          >
